...
export default function HomeScreen() {
  ...
  // 1. The blur/lock ONLY shows if the Context explicitly says it is locked
  const showLockOverlay = isLocked;
  // 2. If the time is 0 but they are NOT locked, they are a paid Premium user
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.topPaddedSection}>
          ...
          {/* --- DYNAMIC TIMER (Hidden for Premium Users) --- */}
          {!isPremiumUser && (
          ...
          {/* --- TRIAL ENDED CARD --- */}
          {/* Uses showLockOverlay instead of isTrialEnded */}
          {showLockOverlay && (
        ...
        <View style={styles.lockedContentWrapper}>
          ...
          <View style={styles.innerContentPadding}>
            <TouchableOpacity
              ...
              disabled={showLockOverlay} // Updated!
            >
              <ImageBackground
            ...
            <View style={styles.sectionHeader}>
              ...
              <TouchableOpacity disabled={showLockOverlay}>
          ...
          <ScrollView
            ...
            scrollEnabled={!showLockOverlay} // Updated!
          >
            <View style={{ width: 20 }} />
            <TouchableOpacity activeOpacity={0.8} disabled={showLockOverlay} onPress={() => navigation.navigate('CategoryList', { categoryId: 'summer_makeup' })}>
            ...
            <TouchableOpacity activeOpacity={0.8} disabled={showLockOverlay} onPress={() => navigation.navigate('CategoryList', { categoryId: 'autumn_accessories' })}>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#F5EBE1' },
  scrollContent: { paddingTop: Platform.OS === 'android' ? 40 : 10 },
  ...
  greeting: { fontFamily: 'Inter_600SemiBold', fontSize: 18, color: '#333' },
  subtitle: { fontFamily: 'Inter_400Regular', fontSize: 12, color: '#777', marginTop: 2 },
  ...
  timerContainer: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: '#B88A60', backgroundColor: 'transparent' },
  timerContainerEnded: { borderColor: '#D4CDC4', backgroundColor: '#EBE3DB' },
  ...
  trialCard: { backgroundColor: '#EBE3DB', borderRadius: 24, padding: 24, marginBottom: 24, overflow: 'hidden' },
  trialWatermark: { position: 'absolute', bottom: -20, right: -20, opacity: 0.4 },
  ...
  blurOverlay: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(245, 235, 225, 0.45)' },
  lockIconContainer: { width: 70, height: 70, borderRadius: 35, backgroundColor: 'rgba(30, 30, 30, 0.85)', justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 5, elevation: 6 },
  customLockPng: { width: 35, height: 35, resizeMode: 'contain' },
  heroWrapper: { shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.15, shadowRadius: 15, elevation: 8, marginBottom: 16 },
  ...
  heroCategory: { color: '#FFF', fontSize: 11, fontFamily: 'Inter_600SemiBold', letterSpacing: 1, marginBottom: 8 },
  heroTitle: { color: '#FFF', fontSize: 28, fontFamily: 'PlayfairDisplay_600SemiBold', marginBottom: 12 },
  exploreBtn: { flexDirection: 'row', alignItems: 'center' },
  exploreBtnText: { color: '#FFF', fontSize: 12, fontFamily: 'Inter_500Medium', letterSpacing: 0.5, marginRight: 4 },
  ...
  sectionTitle: { fontSize: 20, fontFamily: 'Inter_600SemiBold', color: '#333' },
  viewAllText: { fontSize: 13, color: '#888', fontFamily: 'Inter_500Medium' },
  horizontalScroll: { paddingBottom: 20 },
  pickCard: { width: 160, height: 160, marginRight: 16, justifyContent: 'flex-end', padding: 16 },
  pickOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.25)', borderRadius: 16 },
  pickTitle: { color: '#FFF', fontSize: 16, fontFamily: 'Inter_500Medium', lineHeight: 22 },
