  ...
  import { View, Text, StyleSheet, Image, ScrollView, TouchableOpacity, Platform, ImageBackground, Dimensions, NativeSyntheticEvent, NativeScrollEvent } from 'react-native';
  ...
  const STATIC_FEATURED = [
    {
      ...
      title: 'Beige Trench and Denim',
      image: require('../../assets/featured.png') 
    },
    {
      id: 'feat-2',
      category: 'WINTER ESSENTIALS',
      title: 'Cozy Knits & Layers',
      image: { uri: 'https://images.unsplash.com/photo-1608228068998-500b3e51225d?q=80&w=1000' }
    },
    {
      id: 'feat-3',
      category: 'EVENING WEAR',
      title: 'Midnight Silk Slip',
      image: { uri: 'https://images.unsplash.com/photo-1539008835657-9e8e9680c956?q=80&w=1000' }
    }
  ];
        ...
        >
          ...
          <View style={styles.lockedContentWrapper}>
            ...
            <View style={styles.carouselContainer}>
              ...
              >
                {STATIC_FEATURED.map((look, index) => (
                  <TouchableOpacity
                    key={look.id}
                    style={[
                      styles.heroWrapper, 
                      { marginRight: index === STATIC_FEATURED.length - 1 ? 0 : CAROUSEL_GAP }
                    ]}
                    activeOpacity={0.9}
